          ...
          b.addEventListener("click", function(e) {
            ...
            $.ajax({
              ...
              success: function(data) {
                var add = "<tr id='" + data.id + "'><td>" + data.first_name + "</td><td>" + data.last_name + "</td><td>" +  data.email + "</td><td>" +  data.phone_number + "</td><td><select><option>Team Leader</option><option selected>Member</option></select></td><td><button type=\"button\" onclick=\"" + remove_row + "(this)\">DELETE</button></td></tr>";
