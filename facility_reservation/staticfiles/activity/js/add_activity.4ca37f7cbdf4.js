...
function autocomplete(inp, arr, no_label, my_attendees, added_a, remove_att) {
  return autocomplete(inp, arr, no_label, my_attendees, added_a, remove_att, "");
}
function autocomplete(inp, arr, no_label, my_attendees, added_a, remove_att, my_tigs) {
...
$("#createActForm").submit(function(event) {
  ...
  var formId = this.id;
  form = this;
  $("#succ-mess").text("You have successfully created an activity");
