          ...
          b.addEventListener("click", function(e) {
            ...
            $.ajax({
              ...
              success: function(data) {
                var add = "<tr id='" + data.id + "'><td>" + data.first_name + "</td><td>" + data.last_name + "</td><td>" +  data.email + "</td><td>" +  data.phone_number + "</td><td><button type=\"button\" class=\"delete-row\" onclick=\"" + remove_row + "(this)\">Delete Row</button></td></tr>";
                $(table).append(add);
...
function mentor_day(inp, event) {
  ...
  $('.show-create-employee-modal').click(function(){
    ...
    $(document).ready(function(){
      ...
      $("#id_letter_intent").attr("style", "height:38px;");
      $("#id_business_permit").attr("accept", "application/pdf");
      $("#id_business_permit").attr("style", "height:38px;");
      $("#id_business_plan").attr("accept", "application/pdf");
      $("#id_business_plan").attr("style", "height:38px;");
      $("#id_financial_statement").attr("accept", "application/pdf");
      $("#id_financial_statement").attr("style", "height:38px;");
      $("#id_list_references").attr("accept", "application/pdf");
      $("#id_list_references").attr("style", "height:38px;");
      $("#id_business_license").attr("accept", "application/pdf");
      $("#id_business_license").attr("style", "height:38px;");
      $("#id_startup_logo").attr("accept", "image/*");
      $("#id_startup_logo").attr("style", "height:38px;");
      ...
      $("#id_sys_customer").removeClass("form-input form-control form-control-sm");
        ...
        $('#modal-create-employee').on('submit', '.create-employee', function(e){
          ...
          if (!err) {
            ...
            var add = "<tr id=''><td>" + firstname + "</td><td>" + lastname + "</td><td>" + email + "</td><td>" + phone + "</td><td><button type=\"button\" class=\"delete-row\" onclick=\"remove_row(this)\">Delete Row</button></td></tr>";
    ...
    $(document).ready(function(){
        ...
        $('#modal-create-founder').on('submit', '.create-founder', function(e){
          ...
          if (!err) {
            ...
            var add = "<tr id=''><td>" + firstname + "</td><td>" + lastname + "</td><td>" + email + "</td><td>" + phone + "</td><td><button type=\"button\" class=\"delete-row\" onclick=\"remove_row(this)\"><i style='color:gray' class='fa fa-minus-circle' aria-hidden='true'></i></button></td></tr>";
