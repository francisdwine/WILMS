      ...
      success: function(data) {
        if (Object.keys(data).length == 0) {
          ...
          for (i=0; i < names.length; i++) {
            var new_div = '<div class="boxstyle" disabled><table style="width: 100% !important;" disabled><tr> <td style=" width:130px;" disabled><span class="labelstyle">Name</span></td> <td><label>: ' + names[i] + '</label></td> </tr><tr> <td ><span class="labelstyle">Self-Rating for '+ sel +'</span></td> <td>: <span class="rated">'
            var j;
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      for (i=0; i < elem_school.length; i++){
        $("#elem").append('<input type="text" placeholder="School" class="form-control inputmodal" value="'+elem_school[i]+'" disabled><input type="text" placeholder="Grade / Year Level" class="form-control inputmodal" value="'+elem_grade[i]+'" disabled><input type="text" placeholder="Private/Public" class="form-control inputmodal" value="'+elem_public[i]+'" disabled><input type="text" placeholder="From" class="form-control inputmodal" value="'+elem_from[i]+'" disabled><input type="text" placeholder="To" class="form-control inputmodal" value="'+elem_to[i]+'" disabled><input type="text" placeholder="Awards" class="form-control inputmodal" value="'+elem_awards[i]+'" disabled><hr>')
      }
