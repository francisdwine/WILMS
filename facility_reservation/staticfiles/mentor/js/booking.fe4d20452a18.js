                ...
                $.ajax({
                  ...
                  success: function(data) {
                    ...
                    for (j=0; j < data.exp.length; j++) {
                      ...
                      var st = "<span class='rated' style='font-size:1rem;'>" + rate + "</span></div>"
...
$("#err-ok").click(function() {
  $.ajax({
    ...
    data: {
      'booker': self,
      'group': $("#group-1 option:selected").text(),
      'desc': $("#desc-1").val(),
      'mentor': $("#mentor-1").val().split('[')[1].split(']')[0],
      'day': $("#day-1").val(),
      'from': $("#from-1").val(),
      'to': $("#to-1").val(),
      'venue': $("#venue-1").val(),
      ...
      success: function(data) {
        if (Object.keys(data).length == 0) {
          ...
          for (i=0; i < names.length; i++) {
            ...
            var new_div = '<div class="boxstyle col-md-12" disabled><hr/><div class="row"><div class="col-md-4" disabled><span class="labelstyle">Name</span></div><div class="col-md-1">:</div><div class="col-md-7"><label class="col-form-label">' + names[i] + '</label></div></div><div class="row"><div class="col-md-4" ><span class="labelstyle col-form-label">Self-Rating for '+ sel +'</span></div><div class="col-md-1">:</div><div class="col-md-7"><span class="rated">'
            var j;
            for (j=0; j < parseInt(rates[i]); j++){
              new_div += '&#x2605;'
            }
            new_div += '</span><span class="rated">'
            for (; j < 5; j++) {
              new_div += '&#x2606;'
            }
            ...
            new_div += '</span></div></div><div class="row"><div class="col-md-4"><span class="labelstyle col-form-label">Other Expertise</span></div><div class="col-md-1">:</div><div class="col-md-7"><div id="exp-'+ ids[i]+'" disabled></div></div></div><div class="row"><div class="col-md-5"></div><div class="col-md-7 text-center"><a href="javascript:void(0);" onclick="all_ment_exp(\''+names[i]+'\', \'#exp-'+ids[i]+'\', true)" disabled><label class="col-form-label btn btn-sm btnView">View All Expertise</label></a></div></div><div class="row"><div class="col-md-4"><span class="labelstyle col-form-label">Available Schedule</span></div><div class="col-md-1">:</div><div class="col-md-7"><div id="sch-'+ ids[i] +'" disabled></div></div></div><div class="row"><div class="col-md-5"></div><div class="col-md-7 text-center"><a href="javascript:void(0);" onclick="all_ment_exp(\''+names[i]+'\', \'#sch-'+ids[i]+'\', false)" disabled><label class="btn btn-sm btnView">View All Schedule</label></a></div></div><div class="row"><div class="col-md-4"><span class="labelstyle col-form-label">Customer Rating</span></div><div class="col-md-1">:</div><div class="col-md-7"><span class="rated">&#x2605; &#x2605; &#x2605;  &#x2606; &#x2606;</span></div></div><div class="row"><div class="col-md-4"><span class="labelstyle col-form-label">Mentees</span></div><div class="col-md-1">:</div><div class="col-md-7"><label>'+mentees[i]+'</label></div></div><div class="row"><div class="col-md-4"><span class="labelstyle col-form-label">Total Hours</span></div><div class="col-md-1">:</div><div class="col-md-7"><label>'+ hours[i] +'</label></div></div><div class="row"><div class="col-md-4"><span class="labelstyle">Cost per Hour</span></div><div class="col-md-1">:</div><div class="col-md-7"><label> '+ cost[i] +'</label></div></div><div class="row"><div class="col-md-2"></div><div class="col-md-4 text-center"><button class="btn btn-sm btnView font-weight-bold" onclick=mentor_sel('+ nam + ')> SELECT</button></div><div class="col-md-2 text-center"><a href="javascript:void(0);" class="btn btnMore" onclick=view_mentor(\''+ ids[i] +'\')> More Details >> </a></div><div class="col-md-4"></div></div></div>'
